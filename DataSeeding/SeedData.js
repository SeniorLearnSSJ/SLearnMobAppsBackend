  ...
  db.MemberBulletin.insertMany([
    {
      ...
      Category: 2,
      Content:
        "Ice Cream Party to celebrate the 1st June for all SeniorLearn Members. Buy one get one free",
    ...
    },
    {
      ...
      Category: 2,
      Content:
        "Come to Ha Loo Loo Dental for your free dental check-up. Offer lasts for the next 3 days!",
  ...
  db.OfficialBulletin.insertMany([
    {
      ...
      Type: 1,
      Content:
        "Dear SeniorLearn members,We are pleased to announce some important updates to our organisation that we believe will enhance your learning experience.Sincerely, The SeniorLearnTeam",
      DateCreated: new Date(2025, 4, 9, 15, 30, 45),
      DateUpdated: new Date(2025, 4, 9, 15, 30, 45),
      Author: "Admin",
    },
    ...
    },
    {
      ...
      Type: 2,
      Content:
        "The SeniorLearn App is out now! It took a long time to make but its finally done. We are also gonna hold lessons on how to use it so stay tune!",
      DateCreated: new Date(2025, 4, 9, 15, 30, 45),
      DateUpdated: new Date(2025, 4, 9, 15, 30, 45),
      Author: "Admin",
    },
